...
class Editor:
	def __init__(self):
		self.__haarDir__ = 'C:/Users/laksh/Desktop/Video_Player-master/Video_Player-master/Haarcascade/'
		self.__cam__ = None
	...
	def isFaceExist(self):
		faceDetect = cv2.CascadeClassifier(self.__haarDir__+'aGest.xml')
	...
	def start(self):
		...
		quit = 0
		OUTERLOOP = True
		playlist = 'C:/Users/laksh/Desktop/Video_Player-master/Video_Player-master/playlist'
		...
		while OUTERLOOP:
			while True:
				...
				print('Face Count : ',_face_count)
				print('Eye Count : ',_eye_count)
